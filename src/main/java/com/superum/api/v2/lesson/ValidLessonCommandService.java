...
public interface ValidLessonCommandService {
     ...
     * @throws GroupNotFoundException if group for groupId field does not exist
     * @throws OverlappingLessonException if lesson is overlapping with another lesson for same teacher
